...
type BatchOpenChannelRequest struct {
	...
	Channels []*BatchOpenChannelRequestItem `protobuf:"bytes,1,rep,name=channels,proto3" json:"channels,omitempty"`
	// The target number of blocks that the funding transaction should be
	// confirmed by.
	TargetConf int32 `protobuf:"varint,2,opt,name=target_conf,json=targetConf,proto3" json:"target_conf,omitempty"`
	// A manual fee rate set in sat/byte that should be used when crafting the
	...
	//Note: If this value is set on channel creation, you will *not* be able to
	//cooperatively close out to a different address.
	CloseAddress         string   `protobuf:"bytes,6,opt,name=close_address,json=closeAddress,proto3" json:"close_address,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *BatchOpenChannelRequest) Reset()         { *m = BatchOpenChannelRequest{} }
func (m *BatchOpenChannelRequest) String() string { return proto.CompactTextString(m) }
...
func (m *BatchOpenChannelRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_BatchOpenChannelRequest.Unmarshal(m, b)
}
func (m *BatchOpenChannelRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_BatchOpenChannelRequest.Marshal(b, m, deterministic)
}
func (m *BatchOpenChannelRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchOpenChannelRequest.Merge(m, src)
}
func (m *BatchOpenChannelRequest) XXX_Size() int {
	return xxx_messageInfo_BatchOpenChannelRequest.Size(m)
}
func (m *BatchOpenChannelRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_BatchOpenChannelRequest.DiscardUnknown(m)
}

var xxx_messageInfo_BatchOpenChannelRequest proto.InternalMessageInfo

func (m *BatchOpenChannelRequest) GetChannels() []*BatchOpenChannelRequestItem {
	if m != nil {
		return m.Channels
	}
	return nil
...
func (m *BatchOpenChannelRequest) GetTargetConf() int32 {
	if m != nil {
		return m.TargetConf
	}
	return 0
...
func (m *BatchOpenChannelRequest) GetSatPerByte() int64 {
	if m != nil {
		return m.SatPerByte
	}
	return 0
...
func (m *BatchOpenChannelRequest) GetMinConfs() int32 {
	if m != nil {
		return m.MinConfs
	}
	return 0
...
func (m *BatchOpenChannelRequest) GetSpendUnconfirmed() bool {
	if m != nil {
		return m.SpendUnconfirmed
	}
	return false
...
func (m *BatchOpenChannelRequest) GetCloseAddress() string {
	if m != nil {
		return m.CloseAddress
	}
	return ""
...
type BatchOpenChannelRequestItem struct {
...
func (m *BatchOpenChannelRequestItem) Reset()         { *m = BatchOpenChannelRequestItem{} }
func (m *BatchOpenChannelRequestItem) String() string { return proto.CompactTextString(m) }
func (*BatchOpenChannelRequestItem) ProtoMessage()    {}
func (*BatchOpenChannelRequestItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{57}
}

func (m *BatchOpenChannelRequestItem) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_BatchOpenChannelRequestItem.Unmarshal(m, b)
}
func (m *BatchOpenChannelRequestItem) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_BatchOpenChannelRequestItem.Marshal(b, m, deterministic)
}
func (m *BatchOpenChannelRequestItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchOpenChannelRequestItem.Merge(m, src)
}
func (m *BatchOpenChannelRequestItem) XXX_Size() int {
	return xxx_messageInfo_BatchOpenChannelRequestItem.Size(m)
}
func (m *BatchOpenChannelRequestItem) XXX_DiscardUnknown() {
	xxx_messageInfo_BatchOpenChannelRequestItem.DiscardUnknown(m)
}

var xxx_messageInfo_BatchOpenChannelRequestItem proto.InternalMessageInfo

func (m *BatchOpenChannelRequestItem) GetNodePubkey() []byte {
	if m != nil {
		return m.NodePubkey
	}
	return nil
...
func (m *BatchOpenChannelRequestItem) GetLocalFundingAmount() int64 {
	if m != nil {
		return m.LocalFundingAmount
	}
	return 0
...
func (m *BatchOpenChannelRequestItem) GetPushSat() int64 {
	if m != nil {
		return m.PushSat
	}
	return 0
...
func (m *BatchOpenChannelRequestItem) GetPrivate() bool {
	if m != nil {
		return m.Private
	}
	return false
...
func (m *BatchOpenChannelRequestItem) GetMinHtlcMsat() int64 {
	if m != nil {
		return m.MinHtlcMsat
	}
	return 0
...
func (m *BatchOpenChannelRequestItem) GetRemoteCsvDelay() uint32 {
	if m != nil {
		return m.RemoteCsvDelay
	}
	return 0
...
type ChannelOpenStatusUpdate struct {
	// Types that are valid to be assigned to Update:
	//	*ChannelOpenStatusUpdate_ChanPending
	//	*ChannelOpenStatusUpdate_ChanOpen
	Update               isChannelOpenStatusUpdate_Update `protobuf_oneof:"update"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}

func (m *ChannelOpenStatusUpdate) Reset()         { *m = ChannelOpenStatusUpdate{} }
func (m *ChannelOpenStatusUpdate) String() string { return proto.CompactTextString(m) }
func (*ChannelOpenStatusUpdate) ProtoMessage()    {}
func (*ChannelOpenStatusUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{58}
}

func (m *ChannelOpenStatusUpdate) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ChannelOpenStatusUpdate.Unmarshal(m, b)
}
func (m *ChannelOpenStatusUpdate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ChannelOpenStatusUpdate.Marshal(b, m, deterministic)
}
func (m *ChannelOpenStatusUpdate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChannelOpenStatusUpdate.Merge(m, src)
}
func (m *ChannelOpenStatusUpdate) XXX_Size() int {
	return xxx_messageInfo_ChannelOpenStatusUpdate.Size(m)
}
func (m *ChannelOpenStatusUpdate) XXX_DiscardUnknown() {
	xxx_messageInfo_ChannelOpenStatusUpdate.DiscardUnknown(m)
}

var xxx_messageInfo_ChannelOpenStatusUpdate proto.InternalMessageInfo

type isChannelOpenStatusUpdate_Update interface {
	isChannelOpenStatusUpdate_Update()
}

type ChannelOpenStatusUpdate_ChanPending struct {
	ChanPending *PendingUpdate `protobuf:"bytes,1,opt,name=chan_pending,json=chanPending,proto3,oneof"`
}

type ChannelOpenStatusUpdate_ChanOpen struct {
	ChanOpen *ChannelOpenUpdate `protobuf:"bytes,2,opt,name=chan_open,json=chanOpen,proto3,oneof"`
}

func (*ChannelOpenStatusUpdate_ChanPending) isChannelOpenStatusUpdate_Update() {}

func (*ChannelOpenStatusUpdate_ChanOpen) isChannelOpenStatusUpdate_Update() {}

func (m *ChannelOpenStatusUpdate) GetUpdate() isChannelOpenStatusUpdate_Update {
	if m != nil {
		return m.Update
	}
	return nil
...
func (m *ChannelOpenStatusUpdate) GetChanPending() *PendingUpdate {
	if x, ok := m.GetUpdate().(*ChannelOpenStatusUpdate_ChanPending); ok {
		return x.ChanPending
	}
	return nil
}

func (m *ChannelOpenStatusUpdate) GetChanOpen() *ChannelOpenUpdate {
	if x, ok := m.GetUpdate().(*ChannelOpenStatusUpdate_ChanOpen); ok {
		return x.ChanOpen
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*ChannelOpenStatusUpdate) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ChannelOpenStatusUpdate_ChanPending)(nil),
		(*ChannelOpenStatusUpdate_ChanOpen)(nil),
	}
}

type BatchOpenStatusUpdate struct {
	Updates              []*ChannelOpenUpdate `protobuf:"bytes,1,rep,name=updates,proto3" json:"updates,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}

func (m *BatchOpenStatusUpdate) Reset()         { *m = BatchOpenStatusUpdate{} }
func (m *BatchOpenStatusUpdate) String() string { return proto.CompactTextString(m) }
func (*BatchOpenStatusUpdate) ProtoMessage()    {}
func (*BatchOpenStatusUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{59}
}

func (m *BatchOpenStatusUpdate) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_BatchOpenStatusUpdate.Unmarshal(m, b)
}
func (m *BatchOpenStatusUpdate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_BatchOpenStatusUpdate.Marshal(b, m, deterministic)
}
func (m *BatchOpenStatusUpdate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchOpenStatusUpdate.Merge(m, src)
}
func (m *BatchOpenStatusUpdate) XXX_Size() int {
	return xxx_messageInfo_BatchOpenStatusUpdate.Size(m)
}
func (m *BatchOpenStatusUpdate) XXX_DiscardUnknown() {
	xxx_messageInfo_BatchOpenStatusUpdate.DiscardUnknown(m)
}

var xxx_messageInfo_BatchOpenStatusUpdate proto.InternalMessageInfo

func (m *BatchOpenStatusUpdate) GetUpdates() []*ChannelOpenUpdate {
	if m != nil {
		return m.Updates
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BatchOpenChannelRequest)(nil), "lnrpc.BatchOpenChannelRequest")
	proto.RegisterType((*BatchOpenChannelRequestItem)(nil), "lnrpc.BatchOpenChannelRequestItem")
	proto.RegisterType((*ChannelOpenStatusUpdate)(nil), "lnrpc.ChannelOpenStatusUpdate")
	proto.RegisterType((*BatchOpenStatusUpdate)(nil), "lnrpc.BatchOpenStatusUpdate")
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
type LightningClient interface {
	...
	// BatchOpenChannel attempts to open multiple singly-funded channels
	//specified in the request.
	BatchOpenChannel(ctx context.Context, in *BatchOpenChannelRequest, opts ...grpc.CallOption) (Lightning_BatchOpenChannelClient, error)
	//
...
func (c *lightningClient) BatchOpenChannel(ctx context.Context, in *BatchOpenChannelRequest, opts ...grpc.CallOption) (Lightning_BatchOpenChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Lightning_serviceDesc.Streams[4], "/lnrpc.Lightning/BatchOpenChannel", opts...)
	if err != nil {
		return nil, err
	}
	x := &lightningBatchOpenChannelClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Lightning_BatchOpenChannelClient interface {
	Recv() (*BatchOpenStatusUpdate, error)
	grpc.ClientStream
}

type lightningBatchOpenChannelClient struct {
	grpc.ClientStream
}

func (x *lightningBatchOpenChannelClient) Recv() (*BatchOpenStatusUpdate, error) {
	m := new(BatchOpenStatusUpdate)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *lightningClient) ChannelAcceptor(ctx context.Context, opts ...grpc.CallOption) (Lightning_ChannelAcceptorClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Lightning_serviceDesc.Streams[5], "/lnrpc.Lightning/ChannelAcceptor", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) CloseChannel(ctx context.Context, in *CloseChannelRequest, opts ...grpc.CallOption) (Lightning_CloseChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Lightning_serviceDesc.Streams[6], "/lnrpc.Lightning/CloseChannel", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) SendPayment(ctx context.Context, opts ...grpc.CallOption) (Lightning_SendPaymentClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Lightning_serviceDesc.Streams[7], "/lnrpc.Lightning/SendPayment", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) SendToRoute(ctx context.Context, opts ...grpc.CallOption) (Lightning_SendToRouteClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Lightning_serviceDesc.Streams[8], "/lnrpc.Lightning/SendToRoute", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) SubscribeInvoices(ctx context.Context, in *InvoiceSubscription, opts ...grpc.CallOption) (Lightning_SubscribeInvoicesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Lightning_serviceDesc.Streams[9], "/lnrpc.Lightning/SubscribeInvoices", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) SubscribeChannelGraph(ctx context.Context, in *GraphTopologySubscription, opts ...grpc.CallOption) (Lightning_SubscribeChannelGraphClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Lightning_serviceDesc.Streams[10], "/lnrpc.Lightning/SubscribeChannelGraph", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) SubscribeChannelBackups(ctx context.Context, in *ChannelBackupSubscription, opts ...grpc.CallOption) (Lightning_SubscribeChannelBackupsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Lightning_serviceDesc.Streams[11], "/lnrpc.Lightning/SubscribeChannelBackups", opts...)
	if err != nil {
		return nil, err
	}
...
type LightningServer interface {
	...
	// BatchOpenChannel attempts to open multiple singly-funded channels
	//specified in the request.
	BatchOpenChannel(*BatchOpenChannelRequest, Lightning_BatchOpenChannelServer) error
	//
	//FundingStateStep is an advanced funding related call that allows the caller
	//to either execute some preparatory steps for a funding workflow, or
	//manually progress a funding workflow. The primary way a funding flow is
...
func (*UnimplementedLightningServer) BatchOpenChannel(req *BatchOpenChannelRequest, srv Lightning_BatchOpenChannelServer) error {
	return status.Errorf(codes.Unimplemented, "method BatchOpenChannel not implemented")
}
...
func _Lightning_BatchOpenChannel_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(BatchOpenChannelRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(LightningServer).BatchOpenChannel(m, &lightningBatchOpenChannelServer{stream})
}

type Lightning_BatchOpenChannelServer interface {
	Send(*BatchOpenStatusUpdate) error
	grpc.ServerStream
}

type lightningBatchOpenChannelServer struct {
	grpc.ServerStream
}

func (x *lightningBatchOpenChannelServer) Send(m *BatchOpenStatusUpdate) error {
	return x.ServerStream.SendMsg(m)
}
